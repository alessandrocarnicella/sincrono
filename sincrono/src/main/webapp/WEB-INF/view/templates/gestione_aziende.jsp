									...
									<div class="row">
										...
										<c:forEach items="${list_az}" var="x">
											<tr>
												...
												<!-- START EDIT AZIENDA -->
												<td data-toggle="tooltip" data-placement="top" title="Edit Azienda">
												...
												<td  data-toggle="tooltip" data-placement="top" title="Delete Azienda">
												...
												<!-- START DELETE AZIENDA -->
												<td data-toggle="tooltip" data-placement="top" title="Print Azienda">
					...
					<div class="modal-body">
						<div class="auto-form-wrapper">
							<form action="GestioneAziendeAdd" method="POST">
								...
								<div class="form-group">
									<div class="input-group">
										<input type="email" class="form-control" placeholder="Email Azienda" name="emailAzienda" required>
									</div>
								</div>
								<div class="form-group">
									<div class="input-group">
...
function notify_danger() {
	$.notify({
		// options
		message: 'Error: Azienda gia esistente' 
	},{
		// settings
		type: 'danger',
		z_index: 2000,
