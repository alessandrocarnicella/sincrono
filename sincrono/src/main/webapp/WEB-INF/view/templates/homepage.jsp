...
<div class="row">
	...
	<c:forEach items="${list_guadagno_totale_aziende}" var="y" varStatus="count">
		<div class="col-lg-6 grid-margin stretch-card" onclick="prova1(id=${count.count},dati=${y})">
			<div class="card">
				<div class="card-body">
					...
					<h4 class="card-title">${list_aziende[count.count-1].nomeAzienda}</h4>
